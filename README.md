...
### 20210621
- このノートブック（https://www.kaggle.com/dehokanta/baseline-post-processing-by-outlier-correction）　
のカルマンフィルタのコードが意味不明だったので紙に行列式を書き出してみた。
...
- In[10]のfor文の意味は何となく分かった。あとはカルマンフィルタの処理。。


### 20210629
- カルマンフィルタの基礎1章読了。本の概要の説明だけ。
...
### 20210704
- 位置情報の前処理についてable prgrammingで解説されてた！！（https://www.youtube.com/watch?v=C-zPVcL5iJU）
- これまんま使えるやつじゃん、早く見ておけばよかった…
